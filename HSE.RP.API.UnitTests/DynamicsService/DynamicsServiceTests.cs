...
namespace HSE.RP.API.UnitTests.DynamicsServiceTest
{
    ...
    bsr_yearid: ProfessionalMembershipTestConfigurations.GetYear(applicantProfessionalBodyMembership.MembershipYear));
        ...
        public async Task GetDynamicsRBIApplications_ShouldReturnListOfDynamicsApplications()
        {
            ...
            HttpTest.ForCallsTo($"{DynamicsOptions.EnvironmentUrl}/api/data/v9.2/bsr_buildingprofessionapplications")
            .WithAnyQueryParam("$select", $"bsr_buildingproappid,bsr_buildingprofessiontypecode,bsr_registrationcommencementdate,bsr_decisioncondition,bsr_regulatorydecisionstatus,bsr_reviewdecision,statuscode")
