...
@Component({
  selector: 'hse-pay-and-submit',
  templateUrl: './pay-and-submit.component.html',
})
export class PayAndSubmitComponent extends PageComponent<string> {

  public static route: string = "pay-and-submit";
  static title: string = "Pay and submit - Register as a building inspector - GOV.UK";
  ...
  override async onSave(applicationService: ApplicationService): Promise<void> {
    applicationService.model.ApplicationStatus = ApplicationStatus.PayAndSubmitComplete;
   }
