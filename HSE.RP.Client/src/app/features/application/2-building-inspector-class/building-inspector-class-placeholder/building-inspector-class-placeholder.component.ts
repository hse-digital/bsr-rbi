...
@Component({
  selector: 'hse-building-inspector-class-placeholder',
  templateUrl: './building-inspector-class-placeholder.component.html',
})
export class BuildingInspectorClassPlaceholderComponent extends PageComponent<string> {

  public static route: string = "building-inspector-class-placeholder";
