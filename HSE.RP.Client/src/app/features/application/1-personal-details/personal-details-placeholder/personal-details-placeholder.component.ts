...
@Component({
  selector: 'hse-personal-details-placeholder',
  templateUrl: './personal-details-placeholder.component.html',
})
export class PersonalDetailsPlaceholderComponent extends PageComponent<string> {

  public static route: string = "personal-details-placeholder";
